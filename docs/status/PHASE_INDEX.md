...
- [ ] **Page tagging: just-in-time + range-tag + verify grid + fearless retag** — `invent-queued` — from /idea 2026-07-04 (user: "ทำที่ fable คิด" — pointing at Fable's independent opinion on the upload→scroll→tag workflow, given same conversation)
