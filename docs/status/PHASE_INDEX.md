...
| HT-Z-3 | FRICTION | ⌘K palette Thai-tag filter ("ชั้น"/"ผังบริเวณ"/"รูปด้าน") returns empty when pages aren't tagged yet, but empty-state only shows `ไม่พบหน้าที่ตรงกับ "ชั้น"` with no hint that the user must run Page Setup first to tag pages. **Fix:** empty-state should add a 1-line hint: `แท็กภาษาไทยจะใช้ได้หลังตั้งค่าหน้าใน Page Setup`. ~3 LOC in `filterPalette()`'s empty branch. | `bma-human-journey-tester` 2026-05-19 (INV-2026-05-19-001b) | `/bma-ui-scope` → `/bma-ui-menu` (palette modal) |
...
INV-2026-05-19-001a `20e2548` · INV-002 `b6856df` · I-E `504b993` · I-D `dc96f62` · I-C `a490c1e` · I-B4 `91fede9` · I-B3 `c011c4e` · SB-002 `33577b7` · INV-001 `<COMMIT_HASH_PENDING>` · HT-5 `89074cb` · HT-4 `a6973ef` · HT-3 `0900e0a` · HT-2 `acd8636` · HT-1 `e21ca98` · U2 `4bcacc6` · U1 `2101dfe` · SB-2026-05-15-001 `fabc2e9` · Pack G `5dc5dd3` · I-B2b `5c76708` · I-B2a `b9f9132` · I-B1 `c38c3e6` · I-A `984eb7e`
