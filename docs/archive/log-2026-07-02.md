# BMA-Plan — Log Archive (2026-06 sessions archived 2026-07-02)

> Archived from root log.md on 2026-07-02 (BUG-20260702-lite-cfss-summary sprint archived 2026-07-02 during BUG-20260702-lite-pagerot-registration sprint; BUG-20260702-lite-arc-summary sprint archived 2026-07-02 during AUDIT-20260702-infra-bundle sprint; SLICE report-edit-1 added 2026-07-02 during BUG-20260702-lite-cfss-summary sprint; AUDIT-20260702-infra-bundle archived 2026-07-02 during the PERF-20260702-lite-foxit-smoothness sprint block; BUG-20260702-lite-pagerot-registration archived 2026-07-03 during the BLOCK-20260703-clear-queue sprint block; PERF-20260702-lite-foxit-smoothness archived 2026-07-03 during the GO-20260703-invariants-streaming-worker-recycle sprint block) to keep root at last-2-sessions.
> Sessions in this file: BUG-20260702-lite-pagerot-registration (2026-07-02) + PERF-20260702-lite-foxit-smoothness (2026-07-02) + AUDIT-20260702-infra-bundle (2026-07-02) + BUG-20260702-lite-cfss-summary (2026-07-02) + BUG-20260702-lite-arc-summary (2026-07-02) + SLICE report-edit-1 Editable lite report (2026-06-05) + invent lite-pdf-render-quality (resumed+completed, 2026-05-28) + invent lite-pdf-render-quality (paused, 2026-05-28) + BUG-20260526-lite-stale-pf-folder-cleanup (2026-05-26) + LOVS-1 Lite Overview Setup wizard (2026-05-25).
...
**Known gaps / follow-ups:**
- Wire report-edit into the production lite report flow (currently behind `#re-toggle` dev gate)
- Promote persistence from localStorage v1 to additive `.bmaplan reportEditState`
- Re-validate print-to-PDF CSS for the jss grid renderer
...
**Known gaps / follow-ups:**
- **PERF-20260702-open-streaming (queued invent, `/lite-invent`)** — the only remaining perf piece. CHH's remaining ~600 MB doc-level heap (fonts/XObjects, PDF.js document-level shared state) is not reachable by page-level cache eviction; needs Range-streaming (`PDFDataRangeTransport`) which touches the page-renderer's buffer-ownership contract and has documented quirks — correctly routed to the invent pipeline rather than a same-day sprint. **(Resolved by GO-20260703-invariants-streaming-worker-recycle: spike ran, verdict NOGO-as-memory-fix, RESHAPE to worker-recycle shipped.)**
...
- `AUDIT-20260702-s2-fitz-lock` still queued — Sprint 4's thumbnail warm was deliberately kept sequential specifically because this per-case PyMuPDF lock doesn't exist yet. **(Resolved 2026-07-03 by `AUDIT-20260702-s2-fitz-lock`, `d0a5dde`.)**
- Verify-Scale port to lite (accuracy gap vs. Foxit) remains queued, unrelated to this perf block. **(Resolved 2026-07-03 by `ACC-20260703-verify-scale-port`, `bea2119`.)**
- `ptToScreen`/`screenToPt` parity-fixture addition remains queued from the pagerot-registration sprint. **(Closed with rationale 2026-07-03 by the V2-U1 invariant registry — registered as invariant I7 rather than added to the literal parity fixture.)**
